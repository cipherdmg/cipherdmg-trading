...
def generateDailyStratSetups(isLastCandleActive):
    ...
    with Progress() as progress:
        ...
        for symbol in symbols:
            ...
            addRowsToTable(symbol,candles,"1D",isLastCandleActive)
            progress.advance(task)


def generateWeeklyStratSetups(isLastCandleActive):
    ...
    with Progress() as progress:
        ...
        for symbol in symbols:
            ...
            addRowsToTable(symbol,candles,"1W",isLastCandleActive)
            progress.advance(task)

    return weeklyTable

def generateMonthlyStratSetups(isLastCandleActive):
    ...
    with Progress() as progress:
        ...
        for symbol in symbols:
            ...
            addRowsToTable(symbol,candles,"1M",isLastCandleActive)
            progress.advance(task)
...
if __name__ == "__main__":
    ...
    dailyTable=generateDailyStratSetups(False)

    weeklyTable=generateWeeklyStratSetups(False)

    monthlyTable=generateMonthlyStratSetups(True)
