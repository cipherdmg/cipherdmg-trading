...
def addTickerToTable(table,markdownTable,ticker,timeframe,stratPattern,enforced, candlePattern, profitTarget, tickers,takeDailyPercentage,takeWeeklyPercentage,takeMonthlyPercentage):
    if(profitTarget >= 2.00):
        ...
        if(timeframe == "1D"):
            ...
            if(lastHammer):
                ...
                dailyTableMarkdown+="| " + str(ticker) + " | " + str(timeframe) + " | " + stratPattern + " | " + stratEnforced + " | " + "$" + str(round(profitTarget, 2)) + " | " + takeDailyPercentage +  " | " + takeWeeklyPercentage + " | " + takeMonthlyPercentage + " | " + candlePattern + " | hammer |\n"
            elif(lastShooter):
                ...
                dailyTableMarkdown+="| " + str(ticker) + " | " + str(timeframe) + " | " + stratPattern + " | " + stratEnforced + " | " + "$" + str(round(profitTarget, 2)) + " | " + takeDailyPercentage +  " | " + takeWeeklyPercentage + " | " + takeMonthlyPercentage + " | " + candlePattern + " | shooter |\n"
            else:
                ...
                dailyTableMarkdown+="| " + str(ticker) + " | " + str(timeframe) + " | " + stratPattern + " | " + stratEnforced + " | " + "$" + str(round(profitTarget, 2)) + " | " + takeDailyPercentage +  " | " + takeWeeklyPercentage + " | " + takeMonthlyPercentage + " | " + candlePattern + " | " + "|\n"
        elif(timeframe == "1W"):
            global weeklyTableMarkdown
            if(lastHammer):
                ...
                weeklyTableMarkdown+="| " + str(ticker) + " | " + str(timeframe) + " | " + stratPattern + " | " + stratEnforced + " | " + "$" + str(round(profitTarget, 2)) + " | " + takeWeeklyPercentage + " | " + takeMonthlyPercentage + " | " + candlePattern + " | hammer |\n"
            elif(lastShooter):
                ...
                weeklyTableMarkdown+="| " + str(ticker) + " | " + str(timeframe) + " | " + stratPattern + " | " + stratEnforced + " | " + "$" + str(round(profitTarget, 2)) + " | " + takeWeeklyPercentage + " | " + takeMonthlyPercentage + " | " + candlePattern + " | shooter |\n"
            else:
                ...
                weeklyTableMarkdown+="| " + str(ticker) + " | " + str(timeframe) + " | " + stratPattern + " | " + stratEnforced + " | " + "$" + str(round(profitTarget, 2)) + " | " + takeWeeklyPercentage + " | " + takeMonthlyPercentage + " | " + candlePattern + " | " + "|\n"
        elif(timeframe == "1M"):
            global monthlyTableMarkdown
            if(lastHammer):
                ...
                monthlyTableMarkdown+="| " + str(ticker) + " | " + str(timeframe) + " | " + stratPattern + " | " + stratEnforced + " | " + "$" + str(round(profitTarget, 2)) + " | " + takeMonthlyPercentage + " | " + candlePattern + " | hammer |\n"
            elif(lastShooter):
                ...
                monthlyTableMarkdown+="| " + str(ticker) + " | " + str(timeframe) + " | " + stratPattern + " | " + stratEnforced + " | " + "$" + str(round(profitTarget, 2)) + " | " + takeMonthlyPercentage + " | " + candlePattern + " | shooter |\n"
            else:
                ...
                monthlyTableMarkdown+="| " + str(ticker) + " | " + str(timeframe) + " | " + stratPattern + " | " + stratEnforced + " | " + "$" + str(round(profitTarget, 2)) + " | " + takeMonthlyPercentage + " | " + candlePattern + " | " + "|\n"
...
def stratBotTimeframe(table,markdownTable,timeframeShortForm, tickers, ticker,takeDailyAmount,takeWeeklyAmount,takeMonthlyAmount, isRealtime):
    ...
    if(isRealtime == True):
        ...
        if("2U" in thirdLastCandle and "1" in secondLastCandle and "2D" in lastCandle):
            ...
            addTickerToTable(table, markdownTable, ticker,timeframeShortForm,stratPattern,True, candlePattern, profitTarget, tickers, takeDailyAmount, takeWeeklyAmount, takeMonthlyAmount)
        ...
        if("2U" in thirdLastCandle and "1" in secondLastCandle):
            ...
            addTickerToTable(table, markdownTable, ticker,timeframeShortForm,stratPattern,False, candlePattern, profitTarget, tickers, takeDailyAmount, takeWeeklyAmount, takeMonthlyAmount)
...
def stratBot():
    ...
    global dailyTableMarkdown
    dailyTableMarkdown ="| Ticker | Timeframe |  Setup     | Enforced  | Profit | Daily | Weekly | Monthly | Last 6 Candles | Candle Pattern |\n"
    dailyTableMarkdown+="| ------ |:--------- |:---------- |:--------- |:------ |:----- |:------ |:------- |:-------------- |:-------------- |\n"
    ...
    global weeklyTableMarkdown
    weeklyTableMarkdown ="| Ticker | Timeframe |  Setup     | Enforced  | Profit | Weekly | Monthly | Last 6 Candles | Candle Pattern |\n"
    weeklyTableMarkdown+="| ------ |:--------- |:---------- |:--------- |:------ |:------ |:------- |:-------------- |:-------------- |\n"
    ...
    global monthlyTableMarkdown
    monthlyTableMarkdown ="| Ticker | Timeframe |  Setup     | Enforced  | Profit |Monthly | Last 6 Candles | Candle Pattern |\n"
    monthlyTableMarkdown+="| ------ |:--------- |:---------- |:--------- |:------ |:------ |:-------------- |:-------------- |\n"
    ...
    for ticker in tickers:
        ...
        #dailyTableMarkdown, weeklyTableMarkdown, monthlyTableMarkdown
        stratBotTimeframe(dailyTable, dailyTableMarkdown, "1D",daily_candles, ticker, takeDailyAmount, takeWeeklyAmount, takeMonthlyAmount,False)
        stratBotTimeframe(weeklyTable, weeklyTableMarkdown, "1W",weekly_candles, ticker, takeDailyAmount, takeWeeklyAmount, takeMonthlyAmount,True)
        stratBotTimeframe(monthlyTable, monthlyTableMarkdown, "1M",monthly_candles, ticker, takeDailyAmount, takeWeeklyAmount, takeMonthlyAmount,True)
    ...
    md = Markdown(dailyTableMarkdown)
    console.print(md)
